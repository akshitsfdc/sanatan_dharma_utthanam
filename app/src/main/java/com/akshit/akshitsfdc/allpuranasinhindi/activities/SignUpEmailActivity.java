...
public class SignUpEmailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mConfirm = findViewById(R.id.fieldConfirmPassword);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignUpEmailActivity.this, "User already exist or invalid username/password, please correct errors!",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SignUpEmailActivity.this,
                                        "Failed to send verification email to"+user.getEmail()+" Might not be a valid email",
                                        Toast.LENGTH_SHORT).show();
                                navigateToEmailVerification(true);
                            }
                            // [END_EXCLUDE]
    ...
    private boolean validateForm() {
        ...
        if (password.length()<6) {
            mPasswordField.setError("Must be at least 6 characters long.");
            valid = false;
        } else {
            mPasswordField.setError(null);
        }
        ...
        if (!TextUtils.isEmpty(password) && !TextUtils.equals(password, confirm)) {
    ...
    private void navigateToEmailVerification(boolean isEmailSent){
        Intent intent = new Intent(SignUpEmailActivity.this, EmailVarificationActivity.class);
    ...
    private void hideKeyboard(){
        try{
            final InputMethodManager imm = (InputMethodManager) SignUpEmailActivity.this.getSystemService(INPUT_METHOD_SERVICE);
            if (imm != null) {
                imm.hideSoftInputFromWindow(Objects.requireNonNull(SignUpEmailActivity.this.getCurrentFocus()).getWindowToken(), 0);
            }
        }catch (Exception e){
            e.printStackTrace();
        }
