...
public class SearchHardRecyclerViewAdapter  extends RecyclerView.Adapter<SearchHardRecyclerViewAdapter.ViewHolder> {

    private ArrayList<HardCopyModel> hardCopyModels;
    private Context mContext;
    private boolean hasScrolled;

    public SearchHardRecyclerViewAdapter(Context context, ArrayList<HardCopyModel> hardCopyModels) {
    ...
    @NonNull
    @Override
    public SearchHardRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_hard_copy_layout, parent, false);
        return new SearchHardRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchHardRecyclerViewAdapter.ViewHolder holder, int position) {
